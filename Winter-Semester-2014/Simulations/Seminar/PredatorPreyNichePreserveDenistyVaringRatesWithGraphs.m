function [timePrey, totalPrey]=PredatorPreyNichePreserveDenistyVaringRatesWithGraphs(WidthOfMatrix,NumberOfIterations,MinNiche,MaxNiche)
...
%addition of having a Niche where predators cannot get into
...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if MaxNiche > WidthOfMatrix || MinNiche < 1
...
plothandle1 = plot(i,j,'.', ...
    'Color','red', ...
    'MarkerSize',12);
axis([0 WidthOfMatrix+1 0 WidthOfMatrix+1]);

plothandle2 = plot(s,t,'.', ...
    'Color','blue', ...
    'MarkerSize',12);
axis([0 WidthOfMatrix+1 0 WidthOfMatrix+1]);
counter=1;
while counter<=NumberOfIterations
    ...
    TempMat3=rand(WidthOfMatrix)>0.99;
