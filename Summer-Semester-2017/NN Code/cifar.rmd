...
```{r}
library(readr)
sgd <- read_csv("/home/alisaleh/Downloads/ias/Summer-Semester-2017/NN Seminar/Code/sgd.csv")
adam <- read_csv("/home/alisaleh/Downloads/ias/Summer-Semester-2017/NN Seminar/Code/adam.csv")
adgrad <- read_csv("/home/alisaleh/Downloads/ias/Summer-Semester-2017/NN Seminar/Code/adgrad.csv")
```
```{r}
summary(sgd)
summary(adam)
...
legend("topright", inset=.05, title="Algorithm",
  	c("SGD","ADAM","ADGRAD"),  fill=c("red","green","black"), horiz=FALSE)
dev.off()
```
...
plot(sgd$loss, type="l", col="red", main="Training loss",
...
plot(sgd$accuracy, type="l", col="red", main="Training Accuracy",
